...
export default function StoreEpicPage() {
  const deals = storeDeals.filter((deal) => deal.store === 'epic')

  return (
    <div>
      <h1 className="text-3xl font-bold text-white mb-2">Epic Firsatlari</h1>
      <p className="text-gray-400 mb-8">Kampanyalar ve ozel indirimlerin ornek listesi</p>
