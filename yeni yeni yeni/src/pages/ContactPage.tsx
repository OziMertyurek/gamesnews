    ...
    <div className="space-y-6">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <article className="card p-6 space-y-3">
          ...
          <p className="text-gray-300"><span className="text-gray-400">E-posta:</span> iletisim@gamesnews-network.com</p>
      ...
      <section className="card p-6 border-dashed border-gray-700">
        ...
        <p className="text-blue-300 mt-3">Buraya reklam vermek icin bizimle iletisime gecin: iletisim@gamesnews-network.com</p>
      </section>
    </div>
  )
}
