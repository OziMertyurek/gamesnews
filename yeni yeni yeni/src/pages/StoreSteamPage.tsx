...
export default function StoreSteamPage() {
  const deals = storeDeals.filter((deal) => deal.store === 'steam')

  return (
    <div>
      <h1 className="text-3xl font-bold text-white mb-2">Steam Firsatlari</h1>
      <p className="text-gray-400 mb-8">Anlik takip icin ornek kampanya kartlari</p>
